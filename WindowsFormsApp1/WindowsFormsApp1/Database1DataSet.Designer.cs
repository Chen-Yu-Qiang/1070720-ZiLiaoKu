...
namespace WindowsFormsApp1 {
    ...
    public partial class Database1DataSet : global::System.Data.DataSet {
        ...
        public partial class studentDataTable : global::System.Data.TypedTableBase<studentRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public studentRow AddstudentRow(int Id, int Number, string name, System.DateTime birthday) {
            ...
            public int Number {
                get {
                    try {
                        ...
                        throw new global::System.Data.StrongTypingException("資料表 \'student\' 中資料行 \'Number\' 的值是 DBNull。", e);
                    }
                }
                set {
...
namespace WindowsFormsApp1.Database1DataSetTableAdapters {
    ...
    public partial class studentTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[student] WHERE (([Id] = @Original_Id) AND ((@IsNull_Number = 1 AND [Number] IS NULL) OR ([Number] = @Original_Number)) AND ((@IsNull_name = 1 AND [name] IS NULL) OR ([name] = @Original_name)) AND ((@IsNull_birthday = 1 AND [birthday] IS NULL) OR ([birthday] = @Original_birthday)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[student] ([Id], [Number], [name], [birthday]) VALUES (@Id, @Nu" +
                "mber, @name, @birthday);\r\nSELECT Id, Number, name, birthday FROM student WHERE (" +
                "Id = @Id)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[student] SET [Id] = @Id, [Number] = @Number, [name] = @name, [birthday] = @birthday WHERE (([Id] = @Original_Id) AND ((@IsNull_Number = 1 AND [Number] IS NULL) OR ([Number] = @Original_Number)) AND ((@IsNull_name = 1 AND [name] IS NULL) OR ([name] = @Original_name)) AND ((@IsNull_birthday = 1 AND [birthday] IS NULL) OR ([birthday] = @Original_birthday)));
SELECT Id, Number, name, birthday FROM student WHERE (Id = @Id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Number, name, birthday FROM dbo.student";
        ...
        public virtual int Delete(int Original_Id, global::System.Nullable<int> Original_Number, string Original_name, global::System.Nullable<global::System.DateTime> Original_birthday) {
        ...
        public virtual int Insert(int Id, global::System.Nullable<int> Number, string name, global::System.Nullable<global::System.DateTime> birthday) {
        ...
        public virtual int Update(int Id, global::System.Nullable<int> Number, string name, global::System.Nullable<global::System.DateTime> birthday, int Original_Id, global::System.Nullable<int> Original_Number, string Original_name, global::System.Nullable<global::System.DateTime> Original_birthday) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(global::System.Nullable<int> Number, string name, global::System.Nullable<global::System.DateTime> birthday, int Original_Id, global::System.Nullable<int> Original_Number, string Original_name, global::System.Nullable<global::System.DateTime> Original_birthday) {
            return this.Update(Original_Id, Number, name, birthday, Original_Id, Original_Number, Original_name, Original_birthday);
        }
    }
